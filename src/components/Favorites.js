...
const Favorites = () => {
  ...
  return (
    <div className="container mx-auto">
      <h1 className="text-4xl font-bold text-center my-4 text-blue-900 dark:text-yellow-500">Digimons Favoritos</h1>
      <div className="flex justify-center mb-4">
        <select onChange={handleLevelChange} value={selectedLevel} className="border p-2 rounded-lg w-full max-w-md dark:bg-blue-900 dark:text-yellow-500">
      ...
      {filteredFavorites.length === 0 ? (
        <p className="text-center text-gray-700 dark:text-yellow-500">No tienes Digimons favoritos en este nivel.</p>
      ) : (
