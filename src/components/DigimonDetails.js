...
const DigimonDetails = () => {
  ...
  return (
    <div className="container mx-auto my-8 flex justify-center items-center min-h-screen pt-20"> {/* Ajustar el margen superior */}
      <div className="max-w-md bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden transform transition-transform hover:scale-105 hover:shadow-2xl mt-8 md:mt-0">
        ...
        <div className="p-6 bg-gray-800 text-white">
          ...
          <p className="text-gray-300 mb-4">{digimon.level}</p>
          <button
          ...
          <div className="mt-4">
            <Link to="/" className="text-blue-300 hover:underline">Volver a la lista</Link>
          </div>
        </div>
      </div>
    </div>
